...
export const products: Product[] = [
  ...
  },
  {
    ...
    tag: "Alta Aderência",
    tagColor: "#027800",
    category: "Linha para Vinílicos",
    image: "/assets/produtos/Fab grip 2.webp",
    fichaTecnica: "/assets/BOLETINS/FabGrip 3K/Cópia de FICHA TÉCNICA PRIMER SOBREPOSICAO GRIP.pdf",
    description:
      "Promotor de ancoragem monocomponente desenvolvido para preparar bases antes da instalação de revestimentos, integrando a nova Linha para Vinílicos. Atua diretamente na preparação de contrapisos e na sobreposição de pisos antigos.",
    specs: [
      { label: "Tipo", value: "Primer monocomponente à base de emulsão acrílica e cargas minerais" },
      { label: "Aplicação", value: "Rolo de pintura ou pincel" },
      { label: "Consumo", value: "Aproximadamente 0,300 kg/m² por demão" },
      { label: "Cura", value: "2 h parcial · 6 h total" },
      { label: "Cor", value: "Cinza" },
    ],
    features: [
      { title: "Pronto para o uso", desc: "Elimina misturas complexas e reduz o tempo de preparação." },
      { title: "Isento de solventes", desc: "Fórmula segura para aplicação em ambientes internos e externos, sem odores fortes." },
      { title: "Ação em bases lisas", desc: "Ancoragem eficiente mesmo em superfícies com baixa absorção." },
      { title: "Preparo eficiente", desc: "Elemento de transição ideal no sistema de assentamento." },
      { title: "Aplicação rápida", desc: "Fluidez calibrada para espalhamento ágil." },
      { title: "Camadas flexíveis", desc: "Permite a aplicação de até duas demãos, conforme a exigência do projeto." },
    ],
    steps: [
      { n: "01", title: "Preparação da base", desc: "Limpe a área deixando-a seca, isenta de pó, óleo, graxa, mofo ou substâncias soltas." },
      { n: "02", title: "Homogeneização", desc: "Misture bem o conteúdo na embalagem antes de iniciar o uso para garantir a uniformidade." },
      { n: "03", title: "Primeira demão", desc: "Aplique de forma homogênea utilizando um rolo de pintura ou pincel." },
      { n: "04", title: "Segunda demão", desc: "Caso seja necessária maior ancoragem, aplique a segunda camada após o intervalo mínimo de 2 horas." },
      { n: "05", title: "Limpeza pós-uso", desc: "Lave as ferramentas com água logo após a aplicação para evitar a secagem do material." },
    ],
    surfaces: ["Reboco", "Superfícies lisas", "Ladrilhos", "Sobreposição de cerâmicas existentes"],
    related: [
      { title: "FabPrimer 3K", tag: "Alto Rendimento", img: "/assets/produtos/Fab primer 3.webp", slug: "fabprimer-3k" },
      { title: "FabBlock 793", tag: "Barreira de Umidade", img: "/assets/produtos/fab block 2.webp", slug: "fabblock-793" },
      { title: "FabVinil 501", tag: "Fixação Imediata", img: "/assets/produtos/Fab vinil 1.webp", slug: "fabvinil-501" },
    ],
  },
  {
    slug: "fabprimer-3k",
    ...
    tagColor: "#027800",
    category: "Linha para Vinílicos",
    image: "/assets/produtos/Fab primer 3.webp",
    fichaTecnica: "/assets/BOLETINS/FabPrimer 3K/Cópia de FICHA TÉCNICA PRIME BASE.pdf",
    description:
      "Primer base monocomponente projetado para regular a absorção e promover a aderência na sobreposição de contrapisos, parte da nova Linha para Vinílicos. Cria uma película protetora que auxilia na resistência contra a umidade superficial.",
    specs: [
      { label: "Tipo", value: "Primer monocomponente à base de emulsão acrílica e aditivos" },
      { label: "Aplicação", value: "Rolo de pintura ou pincel" },
      { label: "Consumo", value: "Aproximadamente 0,200 kg/m² por demão" },
      { label: "Cura", value: "2 h parcial · 6 h total" },
      { label: "Cor", value: "Branco" },
    ],
    features: [
      { title: "Película protetora", desc: "Gera uma barreira resistente contra a umidade superficial." },
      { title: "Excelente rendimento", desc: "Cobre grandes áreas com menor consumo por metro quadrado." },
      { title: "Praticidade técnica", desc: "Fornecido pronto para o uso, necessitando apenas de homogeneização prévia." },
      { title: "Fórmula limpa", desc: "Composição livre de solventes, contribuindo para um ambiente seguro." },
      { title: "Ancoragem para autonivelante", desc: "Prepara o substrato para receber a massa autonivelante." },
      { title: "Fluidez ideal", desc: "Facilita o espalhamento uniforme, diminuindo o esforço." },
    ],
    steps: [
      { n: "01", title: "Limpeza e lixamento", desc: "Remova poeira, mofo ou gordura e lixe imperfeições ou superfícies com brilho antes de aplicar." },
      { n: "02", title: "Mistura do conteúdo", desc: "Mexa bem o primer dentro do balde para garantir a perfeita distribuição dos aditivos." },
      { n: "03", title: "Aplicação das demãos", desc: "Aplique o material em 2 demãos, respeitando o intervalo de 2 a 3 horas entre elas." },
      { n: "04", title: "Tempo de espera", desc: "Aguarde o período de 6 horas após a segunda demão para iniciar a aplicação do autonivelante." },
      { n: "05", title: "Higienização", desc: "Limpe os rolos e pincéis utilizados com água corrente imediatamente após o término do trabalho." },
    ],
    surfaces: ["Lajes", "Placas cimentícias", "Drywall", "Paredes", "Pedras decorativas", "Massa corrida", "Gesso"],
    related: [
      { title: "FabGrip 3K", tag: "Alta Aderência", img: "/assets/produtos/Fab grip 2.webp", slug: "fabgrip-3k" },
      { title: "FabBlock 793", tag: "Barreira de Umidade", img: "/assets/produtos/fab block 2.webp", slug: "fabblock-793" },
      { title: "FabVinil 501", tag: "Fixação Imediata", img: "/assets/produtos/Fab vinil 1.webp", slug: "fabvinil-501" },
    ],
  },
  {
    slug: "fabblock-793",
    title: "FabBlock 793",
    tag: "Barreira de Umidade",
    tagColor: "#027800",
    category: "Linha para Vinílicos",
    image: "/assets/produtos/fab block 2.webp",
    fichaTecnica: "/assets/BOLETINS/FabBlock 793/Cópia de FICHA TÉCNICA BLOQUEADOR DE VAPOR DE UMIDADE (1).pdf",
    description:
      "Primer epóxi bicomponente livre de solventes, desenvolvido para mitigar problemas de umidade em lajes e contrapisos cimentícios. Essencial para proteger revestimentos sensíveis, ele integra a nova Linha para Vinílicos.",
    specs: [
      { label: "Tipo", value: "Primer epóxi bicomponente (Componente A: Resina / Componente B: Catalisador)" },
      { label: "Proporção de Mistura", value: "2 partes do Componente A para 1 parte do Componente B" },
      { label: "Consumo para Vinílicos", value: "0,150 a 0,180 kg/m² por demão" },
      { label: "Cura", value: "6 h parcial · 24 h total" },
      { label: "Resistência à Umidade", value: "Pressão positiva 0,25 MPa · pressão negativa 0,1 MPa" },
    ],
    features: [
      { title: "Proteção para LVT", desc: "Desenvolvido para viabilizar o assentamento seguro de vinílicos sensíveis à umidade." },
      { title: "Bloqueio de pressões hídricas", desc: "Alta resistência contra pressões hidrostáticas positivas e negativas no substrato." },
      { title: "Viscosidade calibrada", desc: "Fluidez ideal para penetrar nos poros do cimento, promovendo selagem profunda." },
      { title: "Composição pura", desc: "Sistema 100% epóxi e totalmente livre de solventes, evitando odores agressivos na obra." },
      { title: "Tempo de trabalho", desc: "Oferece vida útil da mistura de até 60 minutos, permitindo uma aplicação tranquila." },
      { title: "Alta performance mecânica", desc: "Excelente aderência." },
    ],
    steps: [
      { n: "01", title: "Conferência da base", desc: "O contrapiso deve estar 100% curado (mínimo 7 dias), sem lâmina d'água e com umidade abaixo de 6%." },
      { n: "02", title: "Mistura mecânica", desc: "Una os componentes A e B na proporção 2:1 e use misturador de baixa velocidade por 2 a 5 minutos." },
      { n: "03", title: "Aplicação do sistema", desc: "Espalhe o conteúdo em duas demãos com rolo de pelo curto ou pincel, no intervalo de 6 a 12 horas." },
      { n: "04", title: "Secagem e ancoragem", desc: "Aguarde 24 horas de secagem total e aplique obrigatoriamente o FabGrip 3K para gerar ancoragem." },
      { n: "05", title: "Pós-aplicação", desc: "Aguarde 6 horas após o primer de ancoragem para iniciar o lançamento da massa autonivelante." },
    ],
    surfaces: ["Bases de concreto", "Contrapisos cimentícios", "Lajes"],
    related: [
      { title: "FabGrip 3K", tag: "Alta Aderência", img: "/assets/produtos/Fab grip 2.webp", slug: "fabgrip-3k" },
      { title: "FabPrimer 3K", tag: "Alto Rendimento", img: "/assets/produtos/Fab primer 3.webp", slug: "fabprimer-3k" },
      { title: "FabVinil 501", tag: "Fixação Imediata", img: "/assets/produtos/Fab vinil 1.webp", slug: "fabvinil-501" },
  ...
  },
  {
    slug: "fabvinil-501",
    title: "FabVinil 501",
    tag: "Fixação Imediata",
    tagColor: "#027800",
    category: "Linha para Vinílicos",
    image: "/assets/produtos/Fab vinil 1.webp",
    fichaTecnica: "/assets/BOLETINS/FabVinil 501/Cópia de FICHA TÉCNICA ADESIVO PARA PISOS VINILICOS.pdf",
    description:
      "Adesivo acrílico monocomponente reforçado com carga mineral, desenvolvido para a instalação de revestimentos flexíveis na nova Linha para Vinílicos, proporcionando alta fixação inicial.",
    specs: [
    ...
    features: [
      { title: "Agilidade extrema", desc: "Assenta o revestimento imediatamente após o espelhamento, eliminando a espera pelo tack." },
      { title: "Travamento perfeito", desc: "Fórmula com cargas minerais inertes que ajudam a travar o piso e evitar movimentações." },
      { title: "Alta força de colagem", desc: "Desenvolvido com polímeros acrílicos que proporcionam excelente fixação inicial e final." },
      { title: "Resistência à água", desc: "Estabilidade hídrica após a cura, auxiliando na longevidade do sistema." },
      { title: "Estabilidade em obra", desc: "Pronto para o uso, mitigando falhas de dosagem ou adições incorretas." },
      { title: "Uso profissional", desc: "Desenvolvido sob os parâmetros técnicos das normas ABNT NBR 14917-1 e 14917-2." },
    ],
    steps: [
      { n: "01", title: "Preparo e climatização", desc: "Deixe a base nivelada, limpa e com no máximo 2,5% de umidade; aclimate os pisos por 24 horas entre 18 °C e 27 °C." },
      { n: "02", title: "Aplicação do adesivo", desc: "Espalhe o produto com a desempenadeira dentada A1 em pequenos trechos para não ultrapassar o tempo em aberto." },
      { n: "03", title: "Assentamento imediato", desc: "Posicione as réguas ou mantas de vinílico imediatamente sobre o adesivo úmido (dentro de 10 a 15 minutos)." },
      { n: "04", title: "Esmagamento dos cordões", desc: "Utilize obrigatoriamente um rolo de peso bipartido de no mínimo 50 kg para garantir o contato total." },
      { n: "05", title: "Liberação do tráfego", desc: "Permita o trânsito leve após 3 a 5 horas; o tráfego pesado exige de 24 a 48 horas de cura." },
    ],
    surfaces: ["Revestimentos vinílicos", "Pisos emborrachados", "Contrapisos nivelados ou regularizados (uso interno)"],
    related: [
      { title: "FabGrip 3K", tag: "Alta Aderência", img: "/assets/produtos/Fab grip 2.webp", slug: "fabgrip-3k" },
      { title: "FabPrimer 3K", tag: "Alto Rendimento", img: "/assets/produtos/Fab primer 3.webp", slug: "fabprimer-3k" },
      { title: "FabBlock 793", tag: "Barreira de Umidade", img: "/assets/produtos/fab block 2.webp", slug: "fabblock-793" },
  ...
  },
  {
    slug: "fabvinil-610",
    title: "FabVinil 610",
    tag: "Prática Instalação",
    tagColor: "#027800",
    category: "Linha para Vinílicos",
    image: `${BASE}/Hidrico-Quimica_FAB-VINIL-610.webp`,
    description:
      "Adesivo acrílico monocomponente que integra a Linha para Vinílicos. Desenvolvido para oferecer alta aderência, praticidade e mais agilidade na instalação de revestimentos.",
    specs: [
      { label: "Tipo", value: "Acrílico monocomponente com cargas minerais inertes e aditivos" },
      { label: "Aplicação", value: "Desempenadeira dentada A1" },
      { label: "Consumo", value: "Aproximadamente 0,300 kg/m² por demão" },
      { label: "Tempo em Aberto", value: "Até 45 minutos (varia conforme clima)" },
      { label: "Secagem", value: "48 a 72 horas" },
      { label: "Aparência", value: "Filme seco creme flexível" },
      { label: "Densidade", value: "1,400 ± 0,050 g/cm³" },
      { label: "Teor de sólidos", value: "74,500 ± 3,500%" },
    ],
    features: [
      { title: "Pronto para uso", desc: "Elimina etapas de preparação e agiliza o início da instalação." },
      { title: "Tack permanente", desc: "O revestimento pode ser instalado imediatamente, sem necessidade de aguardar o ponto de tack." },
      { title: "Alta aderência", desc: "Proporciona excelente fixação e travamento do piso vinílico." },
      { title: "Aplicação facilitada", desc: "Favorece um manuseio mais prático durante a instalação." },
      { title: "Boa resistência à água", desc: "Oferece maior segurança para aplicações que exigem resistência e estabilidade." },
      { title: "Ótimo rendimento", desc: "Melhor aproveitamento do produto ao longo da execução." },
    ],
    steps: [
      { n: "01", title: "Preparo e climatização", desc: "Certifique-se de que a superfície esteja limpa, seca e nivelada. Aclimate os pisos por 24 horas entre 18 °C e 27 °C." },
      { n: "02", title: "Aplicação do adesivo", desc: "Utilize desempenadeira dentada A1 para espalhar o produto de forma uniforme sobre a superfície." },
      { n: "03", title: "Instalação do revestimento", desc: "Após a aplicação do adesivo, o piso vinílico deve ser instalado imediatamente, respeitando o tempo em aberto de até 45 minutos." },
      { n: "04", title: "Compactação", desc: "Utilize rolo de peso bipartido de, no mínimo, 50 kg para garantir o assentamento adequado." },
      { n: "05", title: "Liberação do tráfego", desc: "O tráfego leve pode ser liberado entre 3 e 5 horas após a instalação. Para tráfego pesado, aguarde de 24 a 48 horas." },
    ],
    surfaces: ["Mantas vinílicas homogêneas e heterogêneas", "Pisos vinílicos em mantas", "Pisos PVC em ambientes residenciais, comerciais e industriais leves"],
    related: [
      { title: "FabGrip 3K", tag: "Alta Aderência", img: "/assets/produtos/Fab grip 2.webp", slug: "fabgrip-3k" },
      { title: "FabPrimer 3K", tag: "Alto Rendimento", img: "/assets/produtos/Fab primer 3.webp", slug: "fabprimer-3k" },
      { title: "FabVinil 501", tag: "Fixação Imediata", img: "/assets/produtos/Fab vinil 1.webp", slug: "fabvinil-501" },
  ...
  {
    slug: "fabgrip-3k-lixa-quimica",
    title: "FabGrip 3K Lixa Química",
    tag: "Excelente Desempenho",
    tagColor: "#027800",
    category: "Linha para Vinílicos",
    image: `${BASE}/Hidrico-Quimica_FAB-GRIP-3K-Lixa-Quimica.webp`,
    description:
      "Primer monocomponente desenvolvido para preparar superfícies antes da instalação de revestimentos. Como integrante da Linha para Vinílicos, auxilia em aplicações de sobreposição, contribuindo para uma instalação mais segura e eficiente.",
    specs: [
      { label: "Tipo", value: "Primer monocomponente à base de emulsão acrílica, cargas minerais e aditivos" },
      { label: "Aplicação", value: "Rolo de pintura ou pincel" },
      { label: "Consumo", value: "Aproximadamente 0,300 kg/m² por demão" },
      { label: "Cura", value: "2 h parcial · 6 h total" },
      { label: "Temperatura de aplicação", value: "5 °C a 35 °C" },
      { label: "Cor", value: "Cinza" },
    ],
    features: [
      { title: "Fórmula mais segura", desc: "Isento de solventes, sendo indicado para ambientes internos e externos." },
      { title: "Monocomponente", desc: "Não exige mistura antes da aplicação." },
      { title: "Alta aderência", desc: "Excelente desempenho em superfícies lisas ou pouco absorventes." },
      { title: "Aplicação prática", desc: "Espalhamento uniforme com rolo ou pincel." },
      { title: "Até duas demãos", desc: "Permite reforçar a ancoragem conforme a necessidade da superfície." },
      { title: "Isento de solventes", desc: "Fórmula segura para diferentes ambientes." },
    ],
    steps: [
      { n: "01", title: "Preparação da base", desc: "Limpe a superfície, deixando-a seca e livre de pó, gordura, graxa, mofo e partículas soltas." },
      { n: "02", title: "Homogeneização", desc: "Misture o produto antes da aplicação até obter uma consistência uniforme." },
      { n: "03", title: "Primeira demão", desc: "Espalhe o produto utilizando rolo de pintura ou pincel." },
      { n: "04", title: "Segunda demão", desc: "Se necessário, aplique uma segunda camada após o intervalo mínimo de 2 horas." },
      { n: "05", title: "Limpeza", desc: "Lave as ferramentas com água logo após o uso." },
    ],
    surfaces: ["Sobreposições de cerâmicas existentes", "Reboco", "Paredes"],
    related: [
      { title: "FabGrip 3K", tag: "Alta Aderência", img: "/assets/produtos/Fab grip 2.webp", slug: "fabgrip-3k" },
      { title: "FabPrimer 3K", tag: "Alto Rendimento", img: "/assets/produtos/Fab primer 3.webp", slug: "fabprimer-3k" },
      { title: "FabVinil 501", tag: "Fixação Imediata", img: "/assets/produtos/Fab vinil 1.webp", slug: "fabvinil-501" },
  ...
  },
  {
    slug: "fab-plan-h10",
    title: "FabPlan H10",
    tag: "Nivelamento de base",
    tagColor: "#007800",
    category: "Autonivelante para Contrapiso",
    image: `${BASE}/Fab plan H10.webp`,
    description:
      "Autonivelante cimentício desenvolvido para regularização e preparação de substratos. Sua formulação proporciona uniformidade e resistência, criando uma superfície ideal para receber diversos revestimentos.",
    specs: [
      { label: "Tipo", value: "Cimento autonivelante" },
      { label: "Aplicação", value: "Ski rodo nivelador, rastelo nivelador com dentição calibrada ou desempenadeira lisa, seguido de rolo fura-bolhas" },
      { label: "Consumo", value: "Aproximadamente 1,7 kg/m² por mm de espessura" },
      { label: "Temperatura de aplicação", value: "Entre 5 °C e 37 °C" },
      { label: "Aparência", value: "Cinza/branco" },
      { label: "Espessura máxima", value: "10 mm por demão" },
    ],
    features: [
      { title: "Excelente nivelamento", desc: "Forma uma superfície regular e uniforme, facilitando a preparação da base." },
      { title: "Aplicação em grandes áreas", desc: "Sua fluidez contribui para maior produtividade durante a execução." },
      { title: "Alta resistência", desc: "Composição com cimento, cargas minerais, aditivos e polímeros para maior desempenho do sistema." },
      { title: "Espessura ajustável", desc: "Permite aplicações entre 1 mm e 10 mm, conforme a necessidade do projeto." },
      { title: "Preparação para acabamentos", desc: "Proporciona uma base uniforme para receber o revestimento." },
      { title: "Liberação em até 24 horas", desc: "Permite a instalação de pisos laminados, vinílicos e cerâmicos após 24 horas da aplicação." },
    ],
    steps: [
      { n: "01", title: "Preparo da superfície", desc: "Certifique-se de que a base esteja limpa e livre de materiais que prejudiquem a aderência. Quando especificado, utilize FabPrimer 3K para preparação da base." },
      { n: "02", title: "Preparo da mistura", desc: "Adicione aproximadamente 4 litros de água ao recipiente e utilize um misturador mecânico de baixa rotação até obter uma massa homogênea." },
      { n: "03", title: "Aplicação de 3 mm e 5 mm", desc: "Despeje o material sobre a superfície preparada e espalhe com rastelo nivelador ou desempenadeira, respeitando a espessura definida." },
      { n: "04", title: "Acabamento e nivelamento", desc: "Utilize rolo fura-bolhas para eliminar o ar incorporado e favorecer o acabamento uniforme." },
      { n: "05", title: "Aplicação acima de 5 mm", desc: "Execute a aplicação em camadas sucessivas. Aguarde aproximadamente 24 horas entre as demãos e reaplique o FabPrimer 3K, respeitando seu tempo de cura de cerca de 60 minutos antes da próxima camada." },
      { n: "06", title: "Aplicação de 8 mm", desc: "Aplique o FabPrimer 3K e aguarde a cura. Aplique uma camada de FabPlan H10 com 5 mm de espessura. Após 24 horas, reaplique o FabPrimer 3K, aguarde novamente 60 minutos e finalize com uma segunda camada de 3 mm, totalizando 8 mm de espessura." },
    ],
    surfaces: ["Contrapisos cimentícios", "Bases de concreto", "Cerâmicas", "Porcelanatos", "Ladrilhos hidráulicos"],
    related: [
      { title: "FabPlan H50", tag: "Regularização de superfícies", img: `${BASE}/Fab plan H50.webp`, slug: "fab-plan-h50" },
      { title: "FabPrimer 3K", tag: "Alto Rendimento", img: "/assets/produtos/Fab primer 3.webp", slug: "fabprimer-3k" },
      { title: "FabGrip 3K", tag: "Alta Aderência", img: "/assets/produtos/Fab grip 2.webp", slug: "fabgrip-3k" },
    ],
  },
  {
    slug: "fab-plan-h50",
    title: "FabPlan H50",
    tag: "Regularização de superfícies",
    tagColor: "#007800",
    category: "Autonivelante para Contrapiso",
    image: `${BASE}/Fab plan H50.webp`,
    description:
      "Autonivelante cimentício desenvolvido para agilizar a preparação de bases e a sequência da obra. Com boa fluidez e liberação rápida para revestimentos, proporciona uma superfície uniforme e adequada para aplicações diversas.",
    specs: [
      { label: "Tipo", value: "Cimento autonivelante" },
      { label: "Aplicação", value: "Misturador mecânico, rolo dentado, restelo dentado ou ski rodo nivelador" },
      { label: "Consumo", value: "Aproximadamente 1,7 kg/m² por mm de espessura" },
      { label: "Temperatura de aplicação", value: "Entre 5 °C e 37 °C" },
      { label: "Aparência", value: "Cinza" },
    ],
    features: [
      { title: "Liberação rápida", desc: "Permite a instalação de revestimentos laminados, vinílicos e cerâmicos após 12 horas da aplicação." },
      { title: "Maior produtividade", desc: "Contribui para acelerar etapas da obra e otimizar o cronograma de execução." },
      { title: "Boa fluidez", desc: "Facilita o espalhamento e favorece o nivelamento da superfície." },
      { title: "Excelente aderência", desc: "Auxilia na formação de uma base preparada para diferentes tipos de revestimentos." },
      { title: "Aplicação versátil", desc: "Pode ser utilizado em contrapisos cimentícios, concreto e bases preexistentes." },
      { title: "Aplicação de 1 a 10 mm", desc: "Permite realizar a regularização em diferentes espessuras, conforme a necessidade do substrato." },
    ],
    steps: [
      { n: "01", title: "Preparo da superfície", desc: "Certifique-se de que o substrato esteja limpo e livre de materiais que comprometam a aderência. Aplique no mínimo duas demãos de FabPrimer 3K para uniformizar a absorção da base. Em casos de sobreposição de pisos cerâmicos ou porcelanatos, utilize FabGrip 3K." },
      { n: "02", title: "Preparo da mistura", desc: "Com um misturador mecânico de baixa rotação, adicione a quantidade de água indicada na embalagem e prepare até obter uma massa homogênea e sem grumos. Utilize imediatamente após o processo." },
      { n: "03", title: "Aplicação do produto", desc: "Aplique manualmente ou por bombeamento, utilizando rodo dentado ou nivelador para alcançar a espessura desejada." },
      { n: "04", title: "Acabamento e nivelamento", desc: "Passe o rolo fura-bolhas para eliminar o ar incorporado e garantir um resultado uniforme." },
      { n: "05", title: "Limpeza das ferramentas", desc: "Lave todas as ferramentas e equipamentos com água imediatamente após a aplicação do produto." },
    ],
    surfaces: ["Contrapisos cimentícios", "Bases de concreto", "Cerâmicas", "Porcelanatos", "Ladrilhos hidráulicos", "Madeira"],
    related: [
      { title: "FabPlan H10", tag: "Nivelamento de base", img: `${BASE}/Fab plan H10.webp`, slug: "fab-plan-h10" },
      { title: "FabPrimer 3K", tag: "Alto Rendimento", img: "/assets/produtos/Fab primer 3.webp", slug: "fabprimer-3k" },
      { title: "FabGrip 3K", tag: "Alta Aderência", img: "/assets/produtos/Fab grip 2.webp", slug: "fabgrip-3k" },
    ],
  },
